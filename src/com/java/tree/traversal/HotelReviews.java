...
public class HotelReviews {
    ...
    public ArrayList<Integer> doTask(String A, ArrayList<String> B) {
        ArrayList<Integer> result = new ArrayList<>();
        TreeMap<Integer, List<Integer>> map = new TreeMap<>(Collections.reverseOrder());
        String[] goodTokens = A.split("_");
        int index = 0;
        ...
        for (String str : B) {
            ...
            for (String token : goodTokens) {
                if (str.contains("_" + token) || str.contains(token + "_") || str.contains("_" + token + "_")) {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> result = obj.doTask(goodWords, B);
